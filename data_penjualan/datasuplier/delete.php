...
function deleteData($idsuplier, $conn) {
    $response = array();
    ...
    //proses query
    $sql = "DELETE FROM supplier_data WHERE idsuplier='$idsuplier'";
    //jalankan query
